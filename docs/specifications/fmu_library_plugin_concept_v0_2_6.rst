..
   FMU / Synarius-Library / Plugin — Architekturkonzept v0.2.6.

================================================================================
FMU, Synarius-Library und Plugins: Architekturkonzept (v0.2.6)
================================================================================

:Status: **Superseded** — siehe :doc:`fmu_library_plugin_concept_v0_2_7` (v0.2.7).
:Version: 0.2.6 (eingefroren; nur noch historischer Vergleich)
:Vorgänger: :doc:`fmu_library_plugin_concept_v0_2_5` (v0.2.5)
...
*Übergang:* Offene Punkte zu API-Form, ``resource_path``-Struktur und Namensraum (Abschnitt 5)
— Besitz/Dispatch sind in **5.1** normativ festgelegt.
...
v0.1 bleibt Referenz für Laden und Capabilities. **Dieses Dokument (v0.2.6)** ist die aktuelle
Architektur- und Roadmap-Grundlage für FMU/Lib/Synarius Core; ältere Versionen nur historisch.

--------------------------------------------------------------------------------
Änderungen gegenüber v0.2.5 (Kurz)
--------------------------------------------------------------------------------

* **Abschnitt 5.1:** Besitz (PluginRegistry, ElementTypeRegistry, ``register_handlers``), CCP-Alias-Roots
  (``@plugins``, ``@types``), Navigationspfade vs. ``new``-Typ-Token, ``state`` [PROVISIONAL],
  Lebenszyklus [PROVISIONAL]. [OPEN QUESTION] zu Besitz aufgelöst.
...
* :doc:`fmu_library_plugin_concept_v0_2_5` — Konzept v0.2.5 (Vorgänger)
